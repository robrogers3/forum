<template>
	...
	<div :class="dropdownClass" style="">
	    <button class="btn btn-default dropdown-toggle" type="button" id="dropdownMenu1" data-Xtoggle="dropdown" aria-haspopup="true" aria-expanded="true" @click="open = true"><span v-text="channelName"></span>
		<span class="caret"></span>
	    </button>
	    <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
		<li><channel-input @channelEntered="addChannel" v-if="signedIn"></channel-input></li>
...
<script>
 ...
 export default {
	 ...
	 return {
	     open: false,
	     channelName: this.old ? this.old : 'Select Channel'
	 };
     },
     methods: {
